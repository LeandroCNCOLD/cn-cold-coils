...
export function CondenserSelectionPanel({
  ...
  const [manualAirflow, setManualAirflow] = useState(5000);
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
          ...
          <div>
            ...
            <input
              type="number"
              value={deltaTMax}
              onChange={(e) => setDeltaTMax(parseFloat(e.target.value) || 10)}
          ...
          <div>
            ...
            <div className="flex gap-1">
              <button
                ...
                className="flex-1 truncate rounded border border-slate-300 bg-white px-2 py-1.5 text-left text-xs hover:border-orange-400 focus:outline-none disabled:opacity-50"
              >
            ...
            {selectedFan ? (
              ...
              <input
                type="number"
                value={manualAirflow}
                onChange={(e) => setManualAirflow(parseFloat(e.target.value) || 5000)}
      ...
      <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
        <div className="mb-2 flex items-center justify-between">
          ...
          <button
            ...
            className="rounded border border-orange-300 bg-orange-50 px-2 py-1 text-xs font-medium text-orange-700 hover:bg-orange-100"
          >
            + Adicionar geometria
          </button>
        </div>
            ...
            {result.selected && (
              <div className="flex-1 rounded-lg border border-green-200 bg-green-50 p-2 text-xs">
                ...
                <span className="text-green-600">
                  Q_rej = {(result.selected.heat_rejection_w / 1000).toFixed(2)} kW | ΔT = {result.selected.delta_t_k.toFixed(1)} K | A = {result.selected.total_area_m2.toFixed(2)} m²
                </span>
              </div>
            )}
          </div>
