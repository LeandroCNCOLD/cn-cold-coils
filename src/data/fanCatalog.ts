...
export const FAN_CATALOG: FanModel[] = [
  ...
  },
  {
    ...
    "rpm_nominal": "920/670 | 970/560 | 1050/650",
    "sound_lwa_db": 0,
  ...
  },
  {
    ...
    "poles": "4-4",
    "electrical_nominal": "3~400 V (Δ/Y) | 3~460 V (Δ/Y) / 50/60Hz / AC",
    "rpm_nominal": "1290/1030 | 1390/1000 | 1470/1100",
    "sound_lwa_db": 0,
  ...
  },
  {
    ...
    "poles": "4-4",
    "electrical_nominal": "3~400 V (Δ/Y) | 3~460 V (Δ/Y) / 50/60Hz / AC",
    "rpm_nominal": "1290/1020 | 1390/990 | 1480/1100",
    "sound_lwa_db": 0,
  ...
  },
  {
    ...
    "poles": "6-6",
    "electrical_nominal": "3~400 V (Δ/Y) | 3~460 V (Δ/Y) / 50/60Hz / AC",
    "rpm_nominal": "890/610 | 910/510 | 1000/600",
    "sound_lwa_db": 0,
  ...
  },
  {
    ...
    "poles": "4-4",
    "electrical_nominal": "3~400 V (Δ/Y) | 3~460 V (Δ/Y) / 50/60Hz / AC",
    "rpm_nominal": "1400/1210 | 1590/1210 | 1640/1330",
    "sound_lwa_db": 0,
  ...
  },
  {
    ...
    "ip_protection": "IP54",
    "thermal_class": "THCL155",
    "weight_kg": "37.90 (L guard grille suction side), 40.10 (L guard grille two-sided)",
    "curve_available": true,
    "num_curve_sets": 4,
    "curve_sets": [
      {
  ...
  },
  {
    ...
    "poles": "6-6",
    "electrical_nominal": "3~400 V (Δ/Y) | 3~460 V (Δ/Y) / 50/60Hz / AC",
    "rpm_nominal": "900/720 | 980/640 | 1040/740 min⁻¹",
    "sound_lwa_db": 0,
  ...
  },
  {
    ...
    "ip_protection": "IP54",
    "thermal_class": "THCL155",
    "weight_kg": "38.90 (L guard grille suction side), 41.40 (L guard grille two-sided)",
    "curve_available": true,
    "num_curve_sets": 4,
    "curve_sets": [
      {
  ...
  },
  {
    ...
    "poles": "8-8",
    "electrical_nominal": "3~400 V (Δ/Y) | 3~460 V (Δ/Y) / 50/60Hz / AC",
    "rpm_nominal": "680/530 | 750/410 | 790/490 min⁻¹",
    "sound_lwa_db": 0,
  ...
  },
  {
    ...
    "ip_protection": "IP54",
    "thermal_class": "THCL155",
    "weight_kg": "35.30 (L guard grille suction side), 37.80 (L guard grille two-sided)",
    "curve_available": true,
    "num_curve_sets": 4,
    "curve_sets": [
      {
  ...
  },
  {
    ...
    "rpm_nominal": "870/640 | 900/710 min⁻¹",
    "sound_lwa_db": 0,
  ...
  },
  {
    ...
    "ip_protection": "IP54",
    "thermal_class": "THCL155",
    "weight_kg": "59.80 (L guard grille suction side), 63.30 (L guard grille two-sided)",
    "curve_available": true,
    "num_curve_sets": 2,
    "curve_sets": [
      {
  ...
  },
  {
    ...
    "poles": "6-6",
    "electrical_nominal": "3~400 V (Δ/Y) | 3~460 V (Δ/Y) / 50/60Hz / AC",
    "rpm_nominal": "800/560 min⁻¹ | 820/580 min⁻¹ | 880/580 min⁻¹",
    "sound_lwa_db": 0,
    "erp_efficiency_pct": 35.5,
    "erp_n_actual": 40.1,
    "erp_n_target": 40,
  ...
  },
  {
    ...
    "poles": "8-8",
    "electrical_nominal": "3~400 V (Δ/Y) | 3~460 V (Δ/Y) / 50/60Hz / AC",
    "rpm_nominal": "650/490 min⁻¹ | 680/460 min⁻¹ | 740/510 min⁻¹",
    "sound_lwa_db": 0,
